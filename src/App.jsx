...
export default function App() {
  ...
  const handleLogin = (e) => {
    ...
    if (!formattedPhone.startsWith('+')) {
      setError(
        'Telefon numarası uluslararası formatta olmalı (örn: +905551234567)'
      );
      return;
    }
  ...
  const handleRegister = (e) => {
    ...
    const newUser = {
      ...
      password: password,
      avatar:
        'https://placehold.co/100x100/6b7280/white?text=' +
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="absolute top-4 left-0 right-0 text-center z-10">
          <div className="inline-block bg-black/20 backdrop-blur-sm text-white px-4 py-1 rounded-full animate-pulse">
            <span className="font-medium">
              Yeşilbük Köyü Uygulamasına Hoşgeldiniz • Eren Koç tarafından
              yapılmıştır • 2025™
            </span>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/20 relative z-10">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-6">
            <h3 className="font-bold text-emerald-800 text-center mb-2">
              📌 Dernek Destek Bilgileri
            </h3>
            <div className="text-sm text-emerald-700 space-y-1">
              ...
              <p>
                <strong>Dernek:</strong> {DERNEK_ADI}
              </p>
              <p>
                <strong>Banka:</strong> {DERNEK_BANKA}
              </p>
            </div>
          </div>
                ...
                <div className="space-y-3">
                  {poll.options.map((option) => (
                    <button
                      ...
                      disabled={
                        poll.votedBy.includes(user?.id) || user?.isAdmin
                      }
              ...
              <div className="p-5">
                ...
                <div className="flex items-center mt-4 space-x-6">
                  <button
                    ...
                    disabled={
                      !user || user.isAdmin || post.likedBy.includes(user.id)
                    }
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between border-b pb-3">
                ...
                <span className="font-medium">
                  {new Date(user.membership.joinedDate).toLocaleDateString(
                    'tr-TR'
                  )}
                </span>
              </div>
              ...
              <div className="flex justify-between border-b pb-3">
                ...
                <span
                  className={`font-medium ${
                    user.membership.duesPaid ? 'text-green-600' : 'text-red-600'
                  }`}
                >
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-medium ${
                    user.membership.debtAmount > 0
                      ? 'text-red-600'
                      : 'text-green-600'
                  }`}
                >
                  {user.membership.debtAmount > 0
                    ? `${user.membership.debtAmount} TL`
                    : 'Borç Yok'}
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 text-center text-sm text-gray-500">
              ...
              {!user.isAdmin && (
                <p className="mt-1">
                  Profil fotoğrafınızı değiştirmek için ✎ simgesine tıklayın
                </p>
              )}
            </div>
          </div>
        ...
        <main className="max-w-4xl mx-auto py-6 px-4 space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-5">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Köy halkının ihtiyaçlarını öğrenmek için anket oluşturun
            </p>
